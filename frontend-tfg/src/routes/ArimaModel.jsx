...
function ArimaModel({ sensor }) {
  ...
  return (
    <div>
      ...
      {data ?
        <Container fluid>
          <h2 className='text-center'>Modelo ARIMA para el sensor {sensor}</h2>
          <Container fluid>
            <Row>
            ...
            <ShowForecast baseUrl={base_url_api_r} relUrl={`forecast-arima?sensor=${sensor}`} />
          </Container>
        </Container>
        :
