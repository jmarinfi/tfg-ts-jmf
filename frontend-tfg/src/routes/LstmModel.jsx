...
function LstmModel({ sensor }) {
    ...
    return (
      <div>
        ...
        {data ?
          <Container fluid>
            <h2 className='text-center'>Modelo LSTM para el sensor {sensor}</h2>
            <Container fluid>
              <Row>
              ...
              <ShowForecast baseUrl={base_url_api_py} relUrl={`forecast-rnn?sensor=${sensor}&model=LSTM`} />
            </Container>
          </Container>
          :
